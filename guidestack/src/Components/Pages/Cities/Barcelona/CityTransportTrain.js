              ...
              <div className="lg:mb-60">
                ...
                <div className="mt-8">
                  <div className="inline-flex rounded-md shadow">
                    <a
                      href="https://www.renfe.com/es/es/cercanias/rodalies-catalunya" target="_blank" rel="noopener noreferrer"
            ...
            <div className="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
              <div className="relative pl-4 -mr-40 sm:mx-auto sm:max-w-3xl sm:px-0 lg:max-w-screen lg:h-full lg:pl-12">
                <img
                  ...
                  src="https://www.renfe.com/content/dam/renfe/es/Viajeros/Secciones/Cercanias/Mapas/barcelona.png"
                  alt=""
                />
              </div>
            </div>

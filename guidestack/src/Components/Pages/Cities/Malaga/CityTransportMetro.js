    ...
    <>
      <div className="pt-8 overflow-hidden sm:pt-12 lg:relative lg:py-48">
            ...
            <div className="lg:mb-60">
              ...
              <div className="mt-8">
                <div className="inline-flex rounded-md shadow">
                  <a
                    href="https://metromalaga.es/" target="_blank" rel="noopener noreferrer"
        ...
        <div className="sm:mx-auto sm:max-w-3xl sm:px-6">
          <div className="py-4 sm:relative md:mt-12 lg:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <div className="relative pl-4 -mr-40 sm:mx-auto sm:max-w-3xl sm:px-0 lg:max-w-screen lg:h-full lg:pl-12">
              <img
                ...
                src="https://www.redtransporte.com/img/transporte/malaga/metro-malaga/plano-metro-malaga-web.jpg"
                alt=""
              />
            </div>
          </div>
...
export default CityTransportMetro;
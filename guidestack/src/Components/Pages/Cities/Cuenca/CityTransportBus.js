              ...
              <div className="lg:mb-60">
                ...
                <div className="mt-6 sm:max-w-xl">
                  ...
                  <p className="mt-6 text-xl text-gray-500">
                    El autobús es el único transporte urbano que tiene Cuenca, tanto para moverse por la ciudad como para ir a pueblos cercanos.
                  </p>
                </div>
                <div className="mt-8">
                  <div className="inline-flex rounded-md shadow">
                    <a
                      href="https://www.cuenca.es/portal/lang__es/tabid__26275/default.aspx#paradasplano" target="_blank" rel="noopener noreferrer"
            ...
            <div className="py-12 sm:relative sm:mt-12 sm:py-16 lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
              <div className="relative pl-4 -mr-40 sm:mx-auto sm:max-w-3xl sm:px-0 lg:max-w-screen lg:h-full lg:pl-12">
                <img
                  ...
                  src="https://s2.studylib.es/store/data/006563720_1-94f437ada472e033cf56eece8aaa124b.png"
                  alt=""
                />
              </div>
            </div>

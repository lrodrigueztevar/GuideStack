...
const CityTransport = () => {
  const [selectedTransportMethod, setSelectedTransportMethod] = useState('bus')
      ...
      <div className="flex place-content-center">
        <span className="inline-flex shadow-sm rounded-md">
          <button 
            ...
            type="button"
            className="disabled:opacity-50 relative inline-flex items-center px-6 py-4 rounded-l-md border border-gray-300 bg-white text-lg font-medium text-gray-700 hover:bg-gray-50 focus:z-10 focus:text-white focus:bg-cyan-900 focus:outline-none focus:ring-1 focus:ring-cyan-200 focus:border-cyan-200" disabled
          >
            Metro
          </button>
          <button
            ...
            type="button"
            className="disabled:opacity-50 -ml-px relative inline-flex items-center px-6 py-4 rounded-l-md border border-gray-300 bg-white text-lg font-medium text-gray-700 hover:bg-gray-50 focus:z-10 focus:text-white focus:bg-cyan-900 focus:outline-none focus:ring-1 focus:ring-cyan-200 focus:border-cyan-200"
          >
            Autobús
          </button>
          <button 
